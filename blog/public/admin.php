...
<html lang="pt" data-bs-theme="auto">
  <head><script src="assets/js/color-modes.js"></script>
    ...
    <title>Dashboard - SJCWork's Blog</title>
    <link href="https://fonts.cdnfonts.com/css/skirmisher" rel="stylesheet">
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  ...
  <a class="brand-text navbar-brand col-md-3 col-lg-2 me-0 px-3 text-white" href="#">SJCWork's </a>
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <p class="texto">Conteudo texto</p>
    </main>
  </div>
</div>
